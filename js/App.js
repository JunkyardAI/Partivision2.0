...
class App {
    constructor() {
        ...
        // Audio Hooks
        this.audio.onLoaded = () => this.ui.dom.loading.classList.remove('active');
        this.audio.onTimeUpdate = () => this.ui.updateProgress(this.audio.getCurrentTime(), this.audio.getDuration());
        this.audio.onEnded = () => { this.isPlaying=false; this.ui.dom.play.disabled=false; this.ui.dom.pause.disabled=true; };
    ...
    play() { this.audio.play(); this.isPlaying=true; this.ui.dom.play.disabled=true; this.ui.dom.pause.disabled=false; }
    pause() { this.audio.pause(); this.isPlaying=false; this.ui.dom.play.disabled=false; this.ui.dom.pause.disabled=true; }
    ...
    loop() {
        ...
        if(this.isPlaying) {
            ...
            this.viz.update(data, this.params);
                ...
                // Render static when paused so camera still moves
